		...
		<div className="black-bg sticky bottom-0 z-10 pt-10">
			<div className="container-main">
				<div className="row">
					...
					<div className="col-lg-3">
						<div className="footer-box">
							<h4 className="mb-0 text-white footer-heading">
								Menu
							</h4>
							<ul>
								<li>
					...
					<div className="col-lg-3">
						<div className="footer-box">
							...
							<ul>
								...
								<li>
									<Link to="/" className="footer-item">
										2nd floor, 4 WING Avenue ,Panniyankara,
										673003Kozhikode, Kerala
									</Link>
								</li>
							</ul>
						</div>
					...
					<div className="col-lg-12">
						<div className="footer-copy">
							<p className="mb-0 copy-right-text light-greay-color text-center">
